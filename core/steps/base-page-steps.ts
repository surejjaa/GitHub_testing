...
export default class BasePageSteps extends BasePage{
    ...
    async findElementAndClick(selector: By): Promise<void>{
        const element = await this.locateElement(selector);
        await element.click();
    }

    async scrollToElementAndClick(selector: By): Promise<void>{
        const element = await this.locateElement(selector);
        await this.scrollToElement(element)
        await element.click();
    }

    async scrollToElement(selector: WebElement): Promise<void>{
